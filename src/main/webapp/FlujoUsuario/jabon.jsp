        ...
        <section class="py-5">
            ...
            <div class="container px-4 px-lg-5 mt-5" style="margin-top: 0px">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <%for(DTOBuscarProductoCliente bProducto : bBuscarProductoClientes){%>
                    <div class="col mb-5">
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item disabled">
                        <a class="page-link" href="<%=request.getContextPath()%>/Usuario?opcion=Buscar&offset=<%=pagina-1%>">Previous</a>
                    </li>
                    <%}else{%>
                    <li class="page-item">
                        <a class="page-link" href="<%=request.getContextPath()%>/Usuario?opcion=Buscar&offset=<%=pagina-1%>">Previous</a>
                    ...
                    <li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/Usuario?opcion=Buscar&offset=<%=i%>"><%=i%></a></li>
                    <%}%>
                    <%if(pagina == index){%>
                    <li class="page-item disabled">
                        <a class="page-link" href="<%=request.getContextPath()%>/Usuario?opcion=Buscar&offset=<%=pagina+1%>">Next</a>
                    </li>
                    <%}else{%>
                    <li class="page-item">
                        <a class="page-link" href="<%=request.getContextPath()%>/Usuario?opcion=Buscar&offset=<%=pagina+1%>">Next</a>
