                ...
                <tr>
                    <td>
                        <div class="product-item">
                            <a class="product-thumb" href="#"><img src="ImagenesServlet?id=<%=bCarritoCliente.getCodigo()%>" alt="Product"></a>
                        ...
                        <td class="text-center">
                            ...
                            <button formaction="<%=request.getContextPath()%>/Usuario?opcion=borraruno" class="btn btn-outline-danger flex-shrink-0" type="submit">
                                <i class="bi bi-trash"></i>
                            </button>
                            <%session.setAttribute("idcarrito",j);%>
                        </td>
                    <%if(bCarritoCliente.isRequiereReceta()){%>
                        <td class="text-center"><a><label for="<%=i%>" class="btn btn-primary">Subir receta</label>
                            <input onchange="window.alert('Se ha subido el archivo')" name="<%=i%>"  style="visibility: hidden; position: absolute;" id="<%=i%>" type="file" accept="image/*">
                        </a>
                            <%list.add(i);
                            session.setAttribute("listaRecetas",list);%>
                        </td>
                    <%}%>
                    </tr>
                    <%i=i+1;%>
                    ...
                    <div class="modal-dialog" style="display: flex; align-items: center; align-content: center;">
                        <div class="modal-content">
                            ...
                            <div style="text-align: center;"><div class="modal-body">
                                <p class="text-center"> Los pedidos solo estan disponibles entra las 10:00 a 22:00 Horas</p>
                                ...
                                <p class="text-center"> *RECUERDE* Los pedidos solo se pueden cancelar hasta una hora antes de ser recogidos</p>
                                ...
                                <button formaction="<%=request.getContextPath()%>/Usuario?opcion=comprar" type="submit" class="btn btn-primary">Aceptar</button>
                                </div>
                        </div>
                    </div>
                </div>
