...
<section class="py-5">
	...
	<div class="container px-4 px-lg-5 my-5"  style="margin-bottom:5px;">
		<div class="row gx-4 gx-lg-5">
			<div class="col-md-6"><img id="blah" style="width:500px; height:470px;"class="card-img-top mb-5 mb-md-0" src="ImagenesServlet?id=<%=producto.getIdProducto()%>" alt="...">
			...
			<div class="col-md-6">
				<form id="hola" method="POST" enctype="multipart/form-data" action="<%=request.getContextPath() %>/FarmaciaPrincipal?action=update">
					<div>
						<p style="margin-bottom:0px; margin-top:10px;">Nombre producto</p>
						<input disabled name="nombre" class="form-control text-left me-3" id="inputQuantity" value="<%=producto.getNombre()%>" style="max-width: 15rem">
					</div>
					<div>
						<p style="margin-bottom:0px; margin-top:10px;">Stock</p>
						<input name="stock" value="<%=producto.getStock()%>" class="form-control text-left" type="number" value="Stock" style="max-width: 4rem">
					</div>
					<div>
						<p style="margin-bottom:0px; margin-top:10px;">Precio del producto</p>
						<input name="precio" class="form-control text-left" type="number" value="<%=producto.getPrecio()%>" style="max-width: 4rem">
					</div>
					<div>
					...
					<div>
						...
						<input value="<%=producto.getDescripcion()%>" name="descripcion" class="form-control text-left" type="text" style="max-width: 25rem; max-height:25rem; margin-bottom:20px;">
					</div>
					<div class="column">
						<button onclick="return confirm('¿Esta seguro de editar el producto?')" style="margin-left:0px;" class="btn btn-success" type="submit">Editar Producto</button>
					</div>
				</form>
			</div>
		</div>
