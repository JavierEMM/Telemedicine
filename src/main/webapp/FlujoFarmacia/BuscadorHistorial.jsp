            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item disabled">
                        <a class="page-link" href="<%=request.getContextPath()%>/FarmaciaPrincipal?action=BuscarPedido&offset=<%=pag-1%>">Previous</a>
                    </li>
                    <%}else
                    {%>
                    <li class="page-item">
                    ...
                    <li class="page-item"><a class="page-link" href="<%=request.getContextPath()%>/FarmaciaPrincipal?action=BuscarPedido&offset=<%=j%>"><%=j%></a></li>
                    <%}
                        if(pag==index || index==1){%>
                    <li class="page-item disabled">
                        <a class="page-link" href="<%=request.getContextPath()%>/FarmaciaPrincipal?action=BuscarPedido&offset=<%=pag+1%>">Next</a>
                    </li>
                    <%}else {%>
                    <li class="page-item">
                        <a class="page-link" href="<%=request.getContextPath()%>/FarmaciaPrincipal?action=BuscarPedido&offset=<%=pag+1%>">Next</a>
